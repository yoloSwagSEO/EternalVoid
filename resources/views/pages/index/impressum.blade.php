...
@section('content')
	<h4 class="mb10">Angaben gemäß § 5 TMG:</h4>
	<address class="fw300">
		Christian Wederka<br /><br />
		Bootsbauerweg 6<br />
		18109 Rostock
	</address>
	<h4 class="mb10 mt30">Kontakt:</h4>
	<address class="fw300">
		Telefon: +49381/1203269<br />
		Telefax: +49381/1203269<br /><br />
		E-Mail: info<i class="fa fa-at"></i>christian-wederka.de
	</address>
	<h4 class="mb10 mt30">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</h4>
	<address class="fw300">
		Christian Wederka
	</address>
	<p>Quelle: <a href="http://www.e-recht24.de">http://www.e-recht24.de</a></p>
	<h4 class="mb10 mt30">Haftungsausschluss (Disclaimer)</h4>
	<h5 class="mb10 mt30">Haftung für Inhalte</h5>
	<p>
	...
	<h5 class="mb10 mt30">Haftung für Links</h5>
	<p>
	...
	<h5 class="mb10 mt30">Urheberrecht</h5>
	<p>
