	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="/messages/outbox">Postausgang ({{ !is_null($message_count) ? $message_count->num_outbox : 0 }})</a></li>
				...
				<div class="panel panel-default mb0">
					<table class="table table-condensed table-hover table-bordered">
						...
						@forelse($messages as $key => $message)
							...
							<tr>
								...
								@if(is_null($message->read_at))
									...
									<i class="fa fa-folder fa-lg" title="Der Empfäger hat die Nachricht noch nicht gelesen."></i>
								@else

									<i class="fa fa-folder-open fa-lg" title="Der Empfäger hat die Nachricht am {{ $help->dt($message->read_at)->format('d.m.Y') }} um {{ $help->dt($message->read_at)->format('H:i:s') }} Uhr gelesen"></i>
								@endif
								...
								<td class="text-center">
									<a href="/messages/moveto/trash/{{ $message->id }}" title="Nachricht vom Postausgang in den Papierkorb verschieben"><i class="fa fa-trash-o fa-lg pr10"></i></a>
						...
						@empty
							...
							<tr>
								<td colspan="5" class="text-center p10"><strong>Es sind keine Nachrichten im Postausgang vorhanden.</strong></td>
							</tr>
						@endforelse
