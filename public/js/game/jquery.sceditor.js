...
;(function ($, window, document) {
	...
	var _templates = {
		...
		toolbarButton:	'<a class="btn btn-default sceditor-button-{name}" data-sceditor-command="{name}" unselectable="on"><i class="fa fa-{icon}"></i></a>',

		emoticon:	'<img src="{url}" data-sceditor-emoticon="{key}" alt="{key}" title="{tooltip}" />',

		fontOpt:	'<li><a class="sceditor-font-option" href="#" data-font="{font}" class="p0"><span style="font-family:{font}">{font}</span></a></li>',

		sizeOpt:	'<li><a class="sceditor-fontsize-option" data-size="{size}" href="#"><span style="font-size:{size}">{size}</font></a></li>',

		pastetext:	'<form class="form-horizontal p5 pb0 pt0"><div class="form-group mb5"><div class="col-md-12"><textarea cols="40" rows="7" id="txt" class="form-control input-sm w100" placeholder="{label}"></textarea></div></div>' +
					'<div class="form-group mb0"><div class="col-md-12"><button type="button" class="btn btn-default btn-sm btn-block button"><i class="fa fa-check pr5"></i>Einfügen</button></div></div></form>',

		table:		'<form class="form-horizontal p5 pb0 pt0"><div class="form-group mb5"><div class="col-md-12"><input type="text" id="rows" class="form-control input-sm" placeholder="Zeilen"/></div></div>' +
					'<div class="form-group mb5"><div class="col-md-12"><input type="text" id="cols" class="form-control input-sm" placeholder="Spalten"/></div></div>' +
					'<div class="form-group mb0"><div class="col-md-12"><button type="button" class="btn btn-default btn-sm btn-block button"><i class="fa fa-check pr5"></i>Einfügen</button></div></div></form>',

		image:		'<form class="form-horizontal p5 pb0 pt0"><div class="form-group mb5"><div class="col-md-12"><input type="text" id="image" class="form-control input-sm" placeholder="http://" /></div></div>' +
					'<div class="form-group mb0"><div class="col-md-12"><button type="button" class="btn btn-default btn-sm btn-block button"><i class="fa fa-check pr5"></i>Einfügen</button></div></div></form>',

		email:		'<form class="form-horizontal p5 pb0 pt0"><div class="form-group mb5"><div class="col-md-12"><input type="text" id="email" class="form-control input-sm" placeholder="E-Mail" /></div></div>' +
					'<div class="form-group mb0"><div class="col-md-12"><button type="button" class="btn btn-default btn-sm btn-block button"><i class="fa fa-check pr5"></i>Einfügen</button></div></div></form>',

		link:		'<form class="form-horizontal p5 pb0 pt0"><div class="form-group mb5"><div class="col-md-12"><input type="text" id="link" class="form-control input-sm" placeholder="http://" /></div></div>' +
					'<div class="form-group mb5"><div class="col-md-12"><input type="text" id="des" class="form-control input-sm" placeholder="Linktext (Optional)"/></div></div>' +
					'<div class="form-group mb0"><div class="col-md-12"><button type="button" class="btn btn-default btn-sm btn-block button"><i class="fa fa-check pr5"></i>Einfügen</button></div></div></form>',

		youtubeMenu:'<form class="form-horizontal p5 pb0 pt0"><div class="form-group mb5"><div class="col-md-12"><input type="text" id="link" class="form-control input-sm" placeholder="http://" /></div></div>' +
					'<div class="form-group mb0"><div class="col-md-12"><button type="button" class="btn btn-default btn-sm btn-block button"><i class="fa fa-check pr5"></i>Einfügen</button></div></div></form>',
	...
	$.sceditor = function (el, options) {
		...
		initEditor = function () {
			...
			$sourceEditor  = $('<textarea class="form-control input-sm"></textarea>').hide();
		...
		initToolBar = function () {
			...
			$.each(groups, function(idx, group) {
				$group  = $('<div class="btn-group btn-group" />');
...
// This is the problem
		...
		base.createDropDown = function (menuItem, dropDownName, content, ieUnselectable) {
			...
			$dropdown = $('<div class="dropdown-menu sceditor-' + dropDownName + '" />')
				.css(dropDownCss)
				.append(content)
				.appendTo($('body'))
	...
	$.sceditor.commands = {
		...
		size: {
			_dropDown: function(editor, caller, callback) {
				...
				for (var i=1; i<= 8; i++) {
					sizex = i == 1 ? '10px' : (i == 2 ? '14px' : (i == 3 ? '16px' : (i == 4 ? '20px' : (i == 5 ? '24px' : (i == 6 ? '32px' : (i == 7 ? '48px' : '72px'))))));
					content.append(_tmpl('sizeOpt', {size: sizex}, true).click(clickFunc));
				}
